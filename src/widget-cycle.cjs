...
class WidgetCycle{
 ...
 press(){const c=this.workspace.config;this.workspace.save({...c,widget:{...c.widget,type:nextWidget(c.widget.type)}});this.changed();clearTimeout(this.timer);this.timer=setTimeout(()=>{this.timer=null;this.apply().catch(()=>{});},200);}
